...
class CourseTest {
    ...
    int weekDuration= 50;
    Student student= new Student( "name", "name@gmail.com", "Address");
    ...
    @Test
    void register_nonexixting_studentadded() {
        course.register(student);
        Student studentAdded= course.getStudents().get(course.getStudents().size()-1);

        assertEquals(student, studentAdded, "The student was not registered");
    }
    @Test
